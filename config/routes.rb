Rails.application.routes.draw do
  ...
  # Anthropic interface
  resources :anthropic_prompt, only: [ :index, :create ]

  # OpenAI interface
  resources :openai_prompt, only: [ :index, :create ]
  ...
  # Kit subscriptions
  get "/newsletter/subscribe", to: "kit#subscribe", as: "kit_subscribe_page"
  get "/newsletter/subscribed", to: "kit#subscribed", as: "kit_subscribed"
  post "/kit/subscribe", to: "kit#create", as: :kit_subscribe

  # Contact Form
  get "/contact", to: "contact#index", as: "contact"
  post "/contact", to: "contact#contact_form_submission", as: :contact_form_submission
